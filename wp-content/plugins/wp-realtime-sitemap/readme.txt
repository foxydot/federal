...
A plugin to make it easy for your site to show all your pages, posts, custom post types, archives, categories and tags as a sitemap.
...
* Russian by [ssvictors](http://wordpress.org/support/profile/ssvictors). **needs updating**
...
Please see the [FAQ](http://wordpress.org/extend/plugins/wp-realtime-sitemap/faq "FAQ") and [Other Notes](http://wordpress.org/extend/plugins/wp-realtime-sitemap/other_notes "Other Notes") tab for further help.
...
This method is no longer supported, please use the shortcode `[wp-realtime-sitemap]` instead in a page or a post, please see the [Installation](http://wordpress.org/extend/plugins/wp-realtime-sitemap/installation "Installation") tab for further help.
