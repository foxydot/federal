...
define('WPRealtimeSitemap_Version', '1.5.3');
...
//			add_action('admin_head', array($this, 'someFunctionHere'));
		...
		function addMeta($links, $file) {
			...
			if (basename($file) == $plugin_file) {
				...
				$donate_link = '<a href="http://goo.gl/JSTOr">' . __('Donate with PayPal', 'wp-realtime-sitemap') . '</a>';
		...
		function addHelp( $help, $screen ) {
			if ( $screen == 'settings_page_wp-realtime-sitemap' ) {
				...
				$help .= '<a href="http://goo.gl/JSTOr">' . __('Donate with PayPal', 'wp-realtime-sitemap').'</a><br />';
